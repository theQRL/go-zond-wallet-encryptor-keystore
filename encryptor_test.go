...
func TestNew(t *testing.T) {
	encryptor := keystorev1.New()
	x, err := encryptor.Encrypt([common.SeedSize]byte{0xaa, 0xff, 0xbb, 0xcc, 0xdd, 0xee, 0xff, 0x00, 0x12, 0x23, 0x45, 0x67, 0x78, 0xe9, 0x42, 0x61, 0x71, 0x9d, 0x3d, 0x4d, 0x5e, 0xff, 0xfc, 0xcc, 0xae, 0xea, 0x82, 0x21, 0x05, 0x01, 0x74, 0x32}, "")
	require.Nil(t, err)
	assert.NotNil(t, x)
}
